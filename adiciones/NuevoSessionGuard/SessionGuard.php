...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function permisoMiembrosAgregar()
    {
        if ($this->request->session()->get('agregarMiembro')!=0)
        {
            return true;
        }
        return false;
    }
    public function permisoMiembrosVisualizar()
    {
        if ($this->request->session()->get('eliminarMiembro')!=0)
        {
            return true;
        }
        return false;
    ...
    public function permisoIniciarSesion()
    {
        if ($this->request->session()->get('iniciar_sesion')!=0)
        {
            return true;
        }
        return false;
    ...
    public function permisoAceptarAusencias()
    {
        if ($this->request->session()->get('aceptar_ausencias')!=0)
        {
            return true;
        }
        return false;
    ...
    {
        return $this->request->session()->get('nombre');
    }
